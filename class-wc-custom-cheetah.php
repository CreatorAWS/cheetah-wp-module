...
class WC_Custom_Cheetah extends WC_Payment_Gateway {
    ...
    public function init_form_fields() {
		$this->form_fields = array(
			...
			'description'    => array(
				...
				'default'     => __( 'Payer avec vos crypto monnaies !', 'cheetah' ),
			),
			'api_key'        => array(
    ...
    public function validate_api_key($api_key) {
        $graphql_url = "https://cheetah-backend-98fc26cfa70e.herokuapp.com/graphql";
	...
	public function process_payment( $order_id ) {
        ...
        $response = wp_remote_post(
          "https://cheetah-backend-98fc26cfa70e.herokuapp.com/graphql",
          [
            'headers' => [
              'Content-Type' => 'application/json',
            ],
